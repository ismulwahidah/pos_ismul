<nav class="navbar navbar-expand-lg shadow-sm" style="background:#F8C8D8;">
    <div class="container">
        ...
        <a class="navbar-brand fw-bold" style="color:#5F5F5F;" href="<?php echo e(route('dashboard')); ?>">
             POS
        </a>
...
</nav><?php /**PATH C:\laragon\www\pos_ismul\resources\views/layouts/navbar.blade.php ENDPATH**/ ?>